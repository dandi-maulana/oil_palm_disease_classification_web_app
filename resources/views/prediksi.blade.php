<x-layout>
    {{-- Semua kode di dalam sini akan dimasukkan ke dalam variabel $slot di layout.blade.php --}}
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-2xl mx-auto">
        ...
        <form id="upload-form">
            <div class="mb-4">
                ...
                <input id="gambar-input" type="file" name="gambar_sawit" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" accept="image/jpeg, image/png, image/jpg" required>
            </div>
            <button type="submit" class="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-lg transition duration-300 ease-in-out">
                Analisis Gambar
            </button>
        </form>
    ...
    {{-- Kita definisikan slot bernama 'script' untuk kode JavaScript --}}
    <x-slot:script>
        <script>
